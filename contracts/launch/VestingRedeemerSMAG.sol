...
contract VestingRedeemerSMAG is OwnableBase {
    ...
    function currentlyClaimable() public view returns (uint256) {
        ...
        if (!userInfo.isRegistered){
            return nrt.balanceOf(msg.sender).mul(percentVestedFor()).div(10000);
        }
    ...
    function claim() public {
        ...
        require(IsMag(stakingToken).transfer(msg.sender, withdrawableAmount));
